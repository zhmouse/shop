...
if($result && mysql_num_rows($result)>0){
    while($rows = mysql_fetch_assoc($result)){
		...
		$option .= '<option value="'.$rows['id'].'" '.($rows['id'] == $_GET['id']?'selected':'').'>'.$space.'</option>';
    }
}
?>
...
<table width="99%" border="0" cellspacing="0" cellpadding="0" id="searchmain">
  ...
  <tr>
    ...
    <a href="add.php" target="mainFrame" onFocus="this.blur()" class="add">添加商品</a>
    </td>
  </tr>
  <tr>
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0" id="main-tab">
	  ...
	  <tr onMouseOut="this.style.backgroundColor='#ffffff'" onMouseOver="this.style.backgroundColor='#edf5ff'">
        ...
        <td align="left" valign="middle" class="borderright borderbottom main-for">
        <label><input type="checkbox" name="status" value="1" class="checkbox">&nbsp;&nbsp;上架</label>
		<label><input type="checkbox" name="is_hot" value="1" class="checkbox">&nbsp;&nbsp;热销</label>
		<label><input type="checkbox" name="is_new" value="1" class="checkbox">&nbsp;&nbsp;新品</label>
		<label><input type="checkbox" name="is_best" value="1" class="checkbox">&nbsp;&nbsp;精品</label>
        </td>
      </tr>
	  <tr onMouseOut="this.style.backgroundColor='#ffffff'" onMouseOver="this.style.backgroundColor='#edf5ff'">
        <td align="right" valign="middle" class="borderright borderbottom bggray">商品描述：</td>
        <td align="left" valign="middle" class="borderright borderbottom main-for">
        <textarea name="describe" rows="10" cols="80" class="textarea" id="txtContent"></textarea>
        </td>
      </tr>
      <tr onMouseOut="this.style.backgroundColor='#ffffff'" onMouseOver="this.style.backgroundColor='#edf5ff'">
