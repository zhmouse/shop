...
$id = $_GET['id'];
$sql = "SELECT id,name,cate_id FROM ".PRE."goods WHERE id={$id}";
//echo $sql;
...
<table width="99%" border="0" cellspacing="0" cellpadding="0" id="searchmain">
  <tr>
    <td width="99%" align="left" valign="top">您的位置：商品管理&nbsp;&nbsp;>&nbsp;&nbsp;添加推送</td>
  </tr>
  <tr>
  ...
  <tr>
    ...
    <form method="post" action="action.php?a=addsend" enctype="multipart/form-data">
	<input type="hidden" name="id" value="<?php echo $rows['id']?>" class="text-word">
	<input type="hidden" name="cate_id" value="<?php echo $rows['cate_id']?>" class="text-word">
    <table width="100%" border="0" cellspacing="0" cellpadding="0" id="main-tab">
	  ...
	  <tr onMouseOut="this.style.backgroundColor='#ffffff'" onMouseOver="this.style.backgroundColor='#edf5ff'">
        ...
        <td align="left" valign="middle" class="borderright borderbottom main-for">
        <label><input type="checkbox" name="status" value="1" class="checkbox">&nbsp;&nbsp;立即推送</label>		
        </td>
      </tr>
	  <tr onMouseOut="this.style.backgroundColor='#ffffff'" onMouseOver="this.style.backgroundColor='#edf5ff'">
